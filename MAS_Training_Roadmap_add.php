...
try
{
    ...
    $strSql .= "'" . $_POST["Select_By_module"] . "',";
    $strSql .= "'" . $_POST["paramCodeCourse"] . "',";
    $strSql .= "'" . $_POST["paramCourseContent"] . "',";
    $strSql .= "'" . $_POST["paramCourseName"] . "',";
    $strSql .= "'" . $_POST["paramPosition"] . "',";
    $strSql .= "'" . $_POST["paramJG"] . "',";
    $strSql .= "'" . $_POST["paramType"] . "',";
    $strSql .= "'" . $_POST["paramInstructor"] . "')";
    echo $strSql . "<br>";
