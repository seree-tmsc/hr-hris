<?php
    ...
    */
    ...
    if (isset($_POST['no']))
    {
        header("Location: admin_pMORG.php");
    }
    else
    {
        try
        {            
            ...
            $strSql = "UPDATE MAS_TRAINING_ORG SET ";
            ...
            $strSql .= "Position_name='" . $_POST["paramupdate_PositionName"] . "' "; 
            ...
            if ($nRecCount >0)
            {
                echo "<script>
                        ...
                        window.location.href='admin_pMORG.php';
                    </script>";
            }
            else
            {
