...
<body class="bg-dark">
                ...
                <div class="panel panel-primary" id="panel-header">
                    ...
                    <div class="panel-body">
                        <form method="post" action="admin_p31.php">
                            ...
                            <!---------------------------------->
                            <!-- Dropdownlist Section Level -->
                            <!---------------------------------->
                            <div class="form-group">
                                <label for="title">Select Section :</label>
                                <select name="selSec" class="form-control" style="width:500px">
    ...
    <script>
        ...
        {
            var dept = $( "select[name='selDept']" ).val();
            var pos = $(this).val();
            console.log(dept);
            console.log(pos);
            ...
            if(pos)
            {
                $.ajax({
                    ...
                    {
                        $('select[name="selSec"]').empty();
                        $('select[name="selSec"]').append('<option value=ALL>ALL</option>');

                        $.each(data, function(key, value){
                            $('select[name="selSec"]').append('<option value="'+ key +'">'+ value +'</option>');
                        });
                    }
                });
            }
