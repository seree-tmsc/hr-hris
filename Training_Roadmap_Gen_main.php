<?php
    ...
    {        
        ...
        $strSql = "select E.emp_code,E.emp_efname,E.job_business,E.job_department,E.job_section,E.job_task,S.BIZ,S.DEP,S.SEC,S.TASK,S.Position,S.TrainingSET,D.Code_Course,D.Course_Name,D.Skill,D.Module ";
        $strSql .= "FROM Emp_Main AS E ";
        $strSql .= "INNER JOIN MAS_TRAINING_SET_MASTER AS S ";
        $strSql .= "ON E.job_business = S.BIZ and E.job_department = S.DEP and E.job_section = S.SEC and E.job_position = S.Position ";
        $strSql .= "INNER JOIN MAS_TRAINING_SET_DETAIL AS D "; 
        $strSql .= "ON S.TrainingSET = D.TrainingSET ";
        $strSql .= "where job_business='" . $_POST["Select_By_BUSI"] . "' and DEP='" . $_POST["Select_By_DEPT"] . "'";
        ...
        {            
            while ($ds = $statement->fetch(PDO::FETCH_NAMED)) 
            {
                ...
                $strSql1 .= "'" . $ds['job_business'] . "',";
                $strSql1 .= "'" . $ds['job_department'] . "',";
                $strSql1 .= "'" . $ds['job_section'] . "',";
                $strSql1 .= "'" . $ds['job_task'] . "',";
                $strSql1 .= "'" . $ds['Position'] . "',";
                $strSql1 .= "'0')";
                //echo $strSql1 . "<br>";
