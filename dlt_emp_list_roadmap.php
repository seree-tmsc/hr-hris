    ...
    try
    {
        ...
        if ($nRecCount >0)
        {
            $html_tag = "<input id='dtl_emp_list' list='myBrowse' name='param_emp_list' 
                            class='form-control'  onchange='Func_Display_Employee_five()' required>
                        </input>";           
            ...
            {                
                ...
                $html_tag .= "<option value='" . $ds["emp_code"] . "/" . $ds["emp_efname"] . "/" . $ds["job_business"] . "/" . $ds["job_department"]. "/" . $ds["job_position"]. "'>" . "</option>";
