...
<div class="row">
    <div class="col-md-12">
        ...
        <!--<h5>User Data:</h5>-->
        <?php
            include "MAS_Training_ORG_list.php";                    
        ?>
    </div>
</div>        
...
<div class="modal fade" id="add_new_record_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal" role="form" action="MAS_Training_ORG_add.php" method="post">
...
<div class="modal fade" id="update_record_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal" role="form" action="MAS_Training_ORG_Update.php" method="post">
                <div class="modal-body">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-3">
                            <label>Position Name:</label>
                            <input type="text" class="form-control" id="update_PositionName" name="paramupdate_PositionName" readonly>
                        </div>
...
<div class="modal fade" id="delete_record_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal" role="form" action="MAS_Training_ORG_del.php" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <div class="col-lg-2">
                            <label>Business:</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-2">
                            <label>Position:</label>
                            <input type="number" class="form-control" id="delete_Position" name="paramdelete_Position" readonly>
                        </div>
                        <div class="col-lg-3">
                            <label>Position Name:</label>
                            <input type="number" class="form-control" id="delete_PositionName" name="paramdelete_PositionName" readonly>
                        </div>
