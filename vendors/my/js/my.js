...
function Func_Display_Employee() 
{
    /*
    var x = document.getElementById("dtl_emp_list").value;
    console.log(x);
    ...
    nLength = x.length;
    n2 = x.indexOf("/");
    var str3 = x.substring(0, n2);
    x = x.substring(n2+1, nLength);    

    nLength = x.length;
    var str4 = x.substring(0, nLength);
...
function Func_Display_Employee_five() 
{
    var x = document.getElementById("dtl_emp_list").value;
    console.log(x);
    var nLength = x.length;            
    ...
    nLength = x.length;
    n3 = x.indexOf("/");
    var str4 = x.substring(0, n3);
    x = x.substring(n3+1, nLength);

    nLength = x.length;
    var str5 = x.substring(0, nLength);
...
function Func_Display_Employee_six() 
{
    var x = document.getElementById("dtl_emp_list").value;
    console.log(x);
    var nLength = x.length;            
    ...
    nLength = x.length;
    n4 = x.indexOf("/");
    var str5 = x.substring(0, n4);
    x = x.substring(n4+1, nLength);
